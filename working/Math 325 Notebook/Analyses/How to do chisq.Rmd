...
```{r}
barplot(table(qs$Critiquing), main="Survey Results from MATH 325 Students", xlab="How much they said they like critiquing", ylim=c(0,96))
```

```{r}
barplot(table(qs$Critiquing), main="Survey Results from MATH 325 Students", xlab="How much they said they like being critiqued", ylim=c(0,96), col="#444444")
par(new = T)
