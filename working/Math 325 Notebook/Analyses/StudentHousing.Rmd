...
```{r, echo=FALSE}
datatable(Rent[,-17], options=list(lengthMenu = c(3,10,30)))
```
...
```{r, echo=FALSE}
hist(Rent$Cost, xlab="Rent (In U.S. Dollars)", main="BYU-Idaho Housing \n One-Semester Entry Level Contract Prices", col="skyblue")
```
...
```{r, echo=FALSE}
outputTable <- rbind(Price=favstats(Rent$Cost), "High Price"=favstats(Rent$CostHigh))
